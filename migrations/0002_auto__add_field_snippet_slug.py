...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('kb_snippet', 'slug', self.gf('django.db.models.fields.SlugField')(default='default', max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Snippet.slug'
        db.delete_column('kb_snippet', 'slug')
    ...
    models = {
        ...
        'kb.snippet': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'default'", 'max_length': '50', 'db_index': 'True'}),
